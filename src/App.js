...
function WithAuthentication({ children }) {
  ...
  return isAuth ? (
    ...
    <Navigate to={`${process.env.REACT_APP_PATH}`} replace />
  );
}
        ...
        <Box sx={{ bgColor: theme.palette.background.paper }}>
          ...
          >
            ...
            <Routes>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/form_cadastro`}
                element={
                  <WithAuthentication>
                    <FormCadastro />
                  </WithAuthentication>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/gerar_cobranca`}
                element={
                  <WithAuthentication>
                    <GenerateBilling />
                  </WithAuthentication>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/links_pagamento`}
                element={
                  <WithAuthentication>
                    <PageLinks />
                  </WithAuthentication>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/table`}
                element={
                  <WithAuthentication>
                    <TableBilling />
                  </WithAuthentication>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/cobrancas_recorrentes`}
                element={
                  <WithAuthentication>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/gerenciar_cobrancas`}
                element={
                  <WithAuthentication>
                    <BillingManager />
                  </WithAuthentication>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/gerenciar_doadores`}
                element={
                  <WithAuthentication>
                    <CustomerManager />
                  </WithAuthentication>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/doacoes`}
                element={
                  <WithAuthentication>
                    <PageBillings />
                  </WithAuthentication>
              ...
              />
              <Route
                path={`${process.env.REACT_APP_PATH}/gerenciar_links`}
                element={
                  <WithAuthentication>
                    <PageLinks />
                  </WithAuthentication>
