...
const Billings = () => {
  ...
  const onSubmit = (data) => {
    ...
    setLoading(true);
    axios
      .post(`${process.env.REACT_APP_URL}/asaas.php?param=11`, data)
      .then((response) => {
            ...
            <Box sx={{ display: "flex", flexWrap: "wrap", gap: "15px" }}>
              ...
              >
                ...
                <Box sx={{ display: "flex", gap: "10px" }}>
                  <TextField
                    type="date"
                    {...register("createdDateInicial")}
                    label="De"
                    InputLabelProps={{ shrink: true }}
                  />
                  <TextField
                    type="date"
                    {...register("createdDateFinal")}
                    label="Até"
                    InputLabelProps={{ shrink: true }}
                  />
                </Box>
              ...
              >
                ...
                <Box sx={{ display: "flex", gap: "10px" }}>
                  <TextField
                    type="date"
                    {...register("receivedDateInicial")}
                    label="De"
                    InputLabelProps={{ shrink: true }}
                  />
                  <TextField
                    type="date"
                    {...register("receivedDateFinal")}
                    label="Até"
                    InputLabelProps={{ shrink: true }}
                  />
                </Box>
